...
# main config
PLUGINSLUG="custom-page-links"
CURRENTDIR=`pwd`
MAINFILE="custom-page-links.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="mkholt" # your svn username
